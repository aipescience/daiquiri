 ...
 * var_dump
 * 
 * (c) Arman Khatalyan and AIP E-Science 2012
 *
 * uses prettyPrint (copyright see below)
 */
...
function var_dump(obj){
    $("#log").append(prettyPrint(obj));
    $("#log").append('<br />');
    $("#log").dialog({title: 'Error', width: 600,height: 400, maxWidth: 600, maxHeight: 400 }).show();
}