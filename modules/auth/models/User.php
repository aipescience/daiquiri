                ...
                if ($changed) {
                    ...
                    if (Daiquiri_Config::getInstance()->auth->notification->updateUser) {
                        ...
                        if ($notificationConfig->webhook) {
                            $this->getModelHelper('webhook')->send($notificationConfig->webhook, array(
