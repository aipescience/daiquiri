...
class Query_Model_Resource_Database extends Daiquiri_Model_Resource_Table {

    public function init($db, $table = null) {
        $this->setTable('Data_Model_DbTable_Tables');
        ...
        if ($db !== Daiquiri_Config::getInstance()->getUserDbName($username)) {
            ...
            if (!in_array($db, $databases)) {
                throw new Daiquiri_Exception_RuntimeError('db not found foo');
            }
        }
