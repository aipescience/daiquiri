        ...
        if ($this->_init->options['config']['query']['guest']) {
            $rules['guest'] = array(
                ...
                'Query_Model_Account' => array(
                    'index','showJob','updateJob','killJob','removeJob','renameJob','moveJob','createGroup','updateGroup','moveGroup','deleteGroup','databases','keywords','nativeFunctions','customFunctions','examples'
                ),
